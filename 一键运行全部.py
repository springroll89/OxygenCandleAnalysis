...
# 步骤1：基础分析
print("\n[1/4] 运行基础分析...")
subprocess.run(["python", "简单分析程序.py"])  # 修正：去掉_v2
time.sleep(1)

# 步骤2：评分排名
print("\n[2/4] 运行评分排名...")
subprocess.run(["python", "评分排名程序.py"])  # 修正：去掉_v2
time.sleep(1)

# 步骤3：对比分析
print("\n[3/4] 运行对比分析...")
subprocess.run(["python", "对比分析程序.py"])  # 修正：去掉_v2
time.sleep(1)
...
subprocess.run(["streamlit", "run", "网页系统.py"])
